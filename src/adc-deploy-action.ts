...
import { ADCDeploymentInfo, ADCLocationURL } from './types';
  ...
  return createTemplateAction({
    ...
    schema: {
      input: z.object({
        ...
        writeCatalogInfoFile: z.boolean().describe('If catalog-info.yaml file should be written in the workspace for usage by a next step of the template execution. In case false it will try to register the ADC entity using the ADC custom entity provider if a catalog connection is available. Default: false').default(false)
      }).required(),
      output: z.object({
