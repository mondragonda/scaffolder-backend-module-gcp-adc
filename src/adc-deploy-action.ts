  ...
  return createTemplateAction({
    ...
    schema: {
      input: z.object({
        ...
        writeCatalogInfoFile: z.boolean().describe('If catalog-info.yaml file should be written in the workspaceDir path. In case false it will try to register the ADC entity using the ADC custom entity provider if available. Default: false').default(false)
      }).required(),
      output: z.object({
